/**
 *Handles messages for invalid address input
 * */

public class Messages {
    public static final String INVALID_CODE = "The postal code is invalid, cod should consist of four numeric values";
